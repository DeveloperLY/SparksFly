...
var moonImg = new Image();   // Create new img element
moonImg.src = 'img/moon.png'; // Set source path
...
function drawBackground(ctx) {
    ...
    if (moonImg.src != '') {
        ctx.drawImage(moonImg, width - moonImg.width/1.3 * 2, moonImg.height, moonImg.width/1.3, moonImg.height/1.3);
    }
